...
*   **Bi-Weekly on Tuesday**: 6:05-7:00 PM Pacific
*   **Bi-Weekly on Wednesday**: 8:05-9:00 AM Pacific
...
1.  **Subscription**: Fill out our [subscription form](https://mlcommons.org/community/subscribe/) and indicate that you’d like to join the **Science Working Group**.
2.  **Google Account**: Associate a Google account with your organizational email address.
3.  **Access**: Once your request to join the Science Working Group is approved, you’ll be able to access the [Science folder in the Public Google Drive](https://drive.google.com/drive/folders/19FK3PXa9DVIe9j7FawwihCb47F0V_nlC).
4.  **Discussion**: To engage in working group discussions, join the group’s channels on the [MLCommons Discord server](https://discord.gg/AfknTWMcJv).

### Contributing to GitHub

To access the public GitHub repositories:

*   **Contribute Code**: If you want to contribute code, please submit your GitHub ID to our subscription form.
*   **Repository**: Visit the [GitHub repository](https://github.com/mlcommons/science).
*   **Guidelines**: Review the [Policy document](https://github.com/mlcommons/science/blob/main/policy.adoc) and [Submission rules](https://github.com/mlcommons/science/blob/main/submit.adoc).

## Latest Updates

*   [New ML Benchmarks for Scientific Discovery](https://mlcommons.org/2023/04/new-ml-benchmarks-for-scientific-discovery/) (April 15, 2023)
